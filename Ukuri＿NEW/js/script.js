...
function PageTopCheck(){
    ...
    var secondTop =  $("#scroll_change").offset().top - 150; //#scroll_changeの上から150pxの位置まで来たら
...
$('.scroll-top a').click(function () {
	...
	if (elmHash == "#scroll_change") {//もし、リンク先のhref の後が#scroll_changeの場合
		var pos = $(elmHash).offset().top;
		$('body,html').animate({scrollTop: pos}, pos); //#scroll_changeにスクロール
	}else{
